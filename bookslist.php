      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbar">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="bookslist.php">Books List</a></li>
...
<div class="container-fluid">
  <div class="row">
    <div class="col-md-12 " style="background: linear-gradient(#ffffff, #ffffcc); ;background-size: cover;background-repeat: no-repeat;width: 100%;color: black;">

    <h1 class="text-center" style="font-size: 40px;margin-top: 100px;font-style: italic;font-family:Zapf Chancery, cursive ;">Books List</h1>
    <br>
      ...
      $sql=mysqli_query($con,"SELECT * FROM bookslist");       
