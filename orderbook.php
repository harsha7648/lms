          ...
          <center>
            <table  style="margin-top: 100px;margin-bottom: 150px;">
              ...
              <tr>
                ...
                <td><input type="text" name="bookname" required placeholder="Name of the book"></td>
              </tr>
              <tr>
                <td style="color: white;">Book_ID</td>
                <td><input type="number" name="book_id" required placeholder ="Unique ID of the book"></td>
              </tr>
              <tr>
                <td style="color: white;">Author Name</td>
                <td><input type="text" name="authorname" required placeholder ="Name of the author"></td>
              </tr>
              <tr>
